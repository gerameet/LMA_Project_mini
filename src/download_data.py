...
class MultilingualCorpusDownloader:
    ...
    def __init__(self, output_dir: str = "data/corpus_data", target_tokens: int = 3_000_000_000):
...
def main():
    ...
    parser.add_argument("--output-dir", default="data/corpus_data", help="Output directory")
